...
install_name_tool -id "@rpath/libEGL.dylib" lib/macos-universal/libEGL.dylib
install_name_tool -id "@rpath/libGLESv2.dylib" lib/macos-universal/libGLESv2.dylib
...
codesign -f -s - lib/macos-universal/libEGL.dylib
codesign -f -s - lib/macos-universal/libGLESv2.dylib
...
otool -L lib/macos-universal/libEGL.dylib
otool -L lib/macos-universal/libGLESv2.dylib
